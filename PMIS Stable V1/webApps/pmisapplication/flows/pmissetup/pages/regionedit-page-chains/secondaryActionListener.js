        ...
        switch (actionId) {
          ...
          case 'about':
            ...
            if ($variables.regionHeaderVar && $variables.regionHeaderVar.region_id) {
              $variables.about.created_by = $variables.regionHeaderVar.created_by;
              $variables.about.created_date = $variables.regionHeaderVar.created_by;
              $variables.about.last_updated_by = $variables.regionHeaderVar.last_updated_by;
              $variables.about.last_updated_date = $variables.regionHeaderVar.last_updated_date;
              $variables.about.last_updated_login = $variables.regionHeaderVar.last_updated_login;
