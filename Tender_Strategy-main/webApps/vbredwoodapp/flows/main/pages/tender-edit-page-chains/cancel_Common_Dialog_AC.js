define([
  ...
  class cancel_Common_Dialog_AC extends ActionChain {
    ...
    '$flow.variables.updateActionObj.p_to_person_id',
      ...
      } else if (dialogId === 'CustomReassignDialog') {
        await Actions.resetVariables(context, {
          variables: [
    '$flow.variables.responseComments',
    '$flow.variables.updateActionObj.p_to_person_id',
        ...
        const customReassignDialogClose = await Actions.callComponentMethod(context, {
        ...
        await Actions.resetVariables(context, {
          variables: [
    '$flow.variables.responseComments',
    '$flow.variables.updateActionObj.p_more_info_type',
  ],
        });
