    ...
    async run(context, { event, originalEvent }) {
      ...
      try {
        ...
        const approvalSubmitBody = {
          ...
          p_trx_id: $variables.postPayloadTypeVar.strategy_hdr_id,
          p_type: $variables.dummyStatusCode === 'RIA' ? 'MORE_INFO' : 'INITIAL'
        };
        ...
        const submitDialogClose3 = await Actions.callComponentMethod(context, {
          selector: '#submitDialog',
          method: 'close',
        });
