define([
  ...
  class searchProjectDetailsAction extends ActionChain {
    ...
    async run(context) {
      ...
      try {
        ...
        console.log("🔍 Searching projects with parameters:");
        ...
        const response = await Actions.callRest(context, {
          endpoint: 'PAM/postPmispamProjectmasterplanSearch', // Update to your actual endpoint
        ...
        $variables.projectDetailsADP.data = response.body.P_OUTPUT || [];
      ...
      if (totalCount > 0) {
        ...
        await Actions.fireDataProviderEvent(context, {
          target: $variables.projectDetailsADP,
          refresh: null,
        });
  ...
  return searchProjectDetailsAction;
});