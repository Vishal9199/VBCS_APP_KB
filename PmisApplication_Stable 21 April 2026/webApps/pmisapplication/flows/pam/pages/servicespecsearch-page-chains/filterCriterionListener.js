        ...
        const processCriteria = (criteria) => {
          criteria.forEach(c => {
            ...
            switch (c.$tag) {
              ...
              case "BudgetFilter":
                // VALUE = BUDGET_NUMBER
                filters.p_budget_number = c.value?.project_number || "";
                console.log("+++2 BUDGET_NUMBER: ", filters.p_budget_number);
                break;

              case "ProjectNameFilter":
                // VALUE = PROJECT_NAME
                filters.p_project_name = c.value?.project_name || "";
                console.log("+++2 PROJECT_NAME: ", filters.p_project_name);
                break;

              case "TenderNameFilter":
                // VALUE = TENDER_NUMBER
                filters.p_tender_name = c.value?.tender_name || "";
                console.log("+++3 TENDER_NAME: ", filters.p_tender_name);
                break;
