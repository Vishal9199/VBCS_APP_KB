...
//   class okPcBtn_AC extends ActionChain {
...
//           } else {
//             await Actions.fireNotificationEvent(context, {
//               summary: 'New Project Charter Initiated Successfully',
//               displayMode: 'persist',
//               type: 'confirmation',
//             });
    ...
    async run(context) {
      const { $page, $flow, $application, $constants, $variables } = context;
        ...
        if (!response4.ok) {
          ...
          $variables.putTaskByNumber = $variables.putTaskByNumber || {};
          $variables.putTaskByNumber.comment = $variables.updateAction.P_COMMENTS || 'Initiated New Project Charter';
          $variables.putTaskByNumber.outcome = 'APPROVE';
          ...
          const toProjectchartereditNewpc = await Actions.navigateToPage(context, {
            page: 'projectcharteredit_newpc',
            params: {
              Ppcid: $variables.projectCharterVar.project_charter_id,
            },
          });
