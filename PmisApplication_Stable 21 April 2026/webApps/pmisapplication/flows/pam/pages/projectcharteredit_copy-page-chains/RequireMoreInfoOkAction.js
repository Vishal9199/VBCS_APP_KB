    ...
    async run(context) {
      ...
      if ($variables.requireMoreFormValid === 'valid') {
        ...
        const response = await Actions.callRest(context, {
          ...
          body: $variables.updateAction_MoreInfo,
        });
        ...
        if (!response.ok) {
          ...
          if (response.body.P_ERROR_CODE === 'E') {
            ...
            if (response.body.P_ERROR_CODE === 'S') {
              ...
              $variables.PCSInstanceUpdate.instanceActionProps.reason = $variables.updateAction_MoreInfo.P_COMMENTS || 'Requested More Information';

              const response2 = await Actions.callRest(context, {
                endpoint: 'processapi/putV1InstancesId2',
                uriParams: {
                  id: $variables.updateAction_MoreInfo.P_INSTANCE_NUMBER,
                },
