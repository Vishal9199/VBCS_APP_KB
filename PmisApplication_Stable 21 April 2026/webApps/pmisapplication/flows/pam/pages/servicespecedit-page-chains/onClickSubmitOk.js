define([
  ...
  class onClickSubmitOk extends ActionChain {
      ...
      try {
        ...
        await Actions.callComponentMethod(context, {
          ...
          const approvalSubmitBody = {
            ...
            p_trx_id: $variables.serviceSpecVar.service_spec_id,
            p_type: $variables.serviceSpecVar.status_code === 'RIA' ? 'MORE_INFO' : 'INITIAL'
          };
          ...
          //     endpoint: 'Integration/postCreateEncumJournal',
          //     body: {"HeaderId": $variables.serviceSpecVar.service_spec_id},
          //   });

          //   await Actions.fireNotificationEvent(context, {
          //     summary: response.body.IntegrationStatus === 'OK' ? 'Encumbrance Journal Created Successfully' : 'Error in Encumbrance Journal Creation',
          //   });
          // }
