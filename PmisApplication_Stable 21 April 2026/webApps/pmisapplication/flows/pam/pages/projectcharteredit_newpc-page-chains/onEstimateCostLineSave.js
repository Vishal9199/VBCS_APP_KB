    ...
    async run(context, { isSaveAndClose }) {
      ...
      try {
        ...
        const costPayload = {
          ...
          // est_capax_cost: $application.functions.formatToOMR($variables.estimateCostVar.est_capax_cost),
          est_capax_cost: $variables.estimateCostVar.est_capax_cost,
          capax_unit: $variables.estimateCostVar.capax_unit,
          // est_opex_cost: $application.functions.formatToOMR($variables.estimateCostVar.est_opex_cost),
