define([
  ...
  class onSaveAddNewMandatoryRefDoc extends ActionChain {
        ...
        if ($variables.attachmentObj.P_TYPE === 'FILE' &&
          ...
          const response = await Actions.callRest(context, {
            ...
            headers: {
              ...
              'X-cache-transactionid': $variables.projectCharterId,
            },
            body: 'null',
          });
          ...
          if (response.body.P_STATUS === 'S') {
            ...
            let bucketlocation = await Actions.callChain(context, {
              chain: 'application:encryptAC',
              params: { input: response.body.P_PRIMARYKEY },
            });
  ...
  return onSaveAddNewMandatoryRefDoc;
});