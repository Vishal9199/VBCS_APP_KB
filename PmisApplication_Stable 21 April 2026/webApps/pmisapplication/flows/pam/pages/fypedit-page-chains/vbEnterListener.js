  ...
  class vbEnterListener extends ActionChain {
    ...
    async loadCreateMode(context) {
      ...
      if ($variables.enterType === 'PROJECT_CREATE') {
        $variables.postFypHdrVar.fy_plan_id = $variables.InputPlanVar.fy_plan_id;
        $variables.postFypHdrVar.mp_calendar_id = $variables.InputPlanVar.mp_calendar_id;
        // $variables.postFypHdrVar.master_plan_name = $variables.InputPlanVar.master_plan_name;
        $variables.postFypHdrVar.fy_plan_name = $variables.InputPlanVar.fy_plan_name;
        $variables.postFypHdrVar.fy_calendar_id = $variables.InputPlanVar.fy_calendar_id;
