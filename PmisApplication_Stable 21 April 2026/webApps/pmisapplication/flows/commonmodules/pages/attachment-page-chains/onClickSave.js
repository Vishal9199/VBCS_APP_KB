    ...
    async run(context, { event, originalEvent }) {
      ...
      if ($variables.formObj.addDialogValidate === 'valid') {
        ...
        if ($variables.attachmentObj.P_TYPE === 'FILE' && 
          ...
          $variables.attachmentObj.P_DOCUMENT_CATEGORY = $variables.tempAttachmentType;

          console.log("+1Check Attachment Type: ", $variables.attachmentObj.P_DOCUMENT_CATEGORY);
          
          console.log("+1Check Attachment Type: ", $variables.tempAttachmentType);
          ...
          // if($variables.P_SCREEN_NAME === 'Project Charter')
          // {
          //   $variables.attachmentObj.P_DOCUMENT_CATEGORY = $variables.selectedPcAttachment;
          // }

          // if($variables.P_SCREEN_NAME === 'Five Year Plan')
          // {
          //   $variables.attachmentObj.P_DOCUMENT_CATEGORY = $variables.selectedfyAttachment;
          // }

          // if($variables.P_SCREEN_NAME === 'Three Year Plan')
          // {
          //   $variables.attachmentObj.P_DOCUMENT_CATEGORY = $variables.selectedtyAttachment;
          // }
          ...
          console.log("+2Check Attachment Type: ", $variables.attachmentObj.P_DOCUMENT_CATEGORY);
          ...
          const response = await Actions.callRest(context, {
            ...
            headers: {
              ...
              'X-cache-referencetype': pass_pc_type,
            },
            body: 'null',
          });
