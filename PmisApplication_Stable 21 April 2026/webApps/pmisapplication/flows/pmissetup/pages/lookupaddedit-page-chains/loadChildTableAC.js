define([
  ...
  class loadChildTableAC extends ActionChain {
    ...
    async run(context) {
      ...
      $variables.encryptedBody.payload = await $application.functions.encryptJs2($application.constants.secretKey, $variables.searchValueObj);

      const response = await Actions.callRest(context, {
        endpoint: 'AOL/postLookupValueSearch',
