define([
  ...
  class vbEnterListener extends ActionChain {
    ...
    async run(context) {
      ...
      $variables.searchObj.p_tender_id = response2.body.items[0].tender_id;
      ...
      try {
        ...
        const response = await Actions.callRest(context, {
          endpoint: 'PDD/postPmispddChangeorderSearch',
...
console.log("   Has Next:", response.body.OUT_HAS_NEXT);
        ...
        $variables.changeRequestADP.data = response.body.P_OUTPUT || [];
      ...
      if (totalCount > 0) {
        ...
        await Actions.fireDataProviderEvent(context, {
          target: $variables.changeRequestADP,
          refresh: null,
        });
