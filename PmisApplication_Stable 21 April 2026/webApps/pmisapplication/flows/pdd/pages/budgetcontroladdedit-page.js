...
define([], function () {
  ...
  class PageModule {
    ...
    /**
     * Builds the oj-table columns array for the Budget Lines table dynamically.
     * Appends the selected year to month headers, Total, and Balance columns.
     *
     * @param {number|string} year - The YEAR from the Budget Control Header
     * @returns {Array} columns array to bind to oj-table columns attribute
     */
