define([
  ...
  class SelectValueItemChangeChain extends ActionChain {
    ...
    $variables.lvCurrentcashExpRow.region_name = data.region_name;
      $variables.lvCurrentcashExpRow.project_name = data.project_name;
      $variables.lvCurrentcashExpRow.tender_number = data.tender_number;
    }
  }
