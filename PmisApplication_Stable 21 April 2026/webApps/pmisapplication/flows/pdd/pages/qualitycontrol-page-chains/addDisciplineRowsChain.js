      ...
      try {
        ...
        if (addResponse.body && addResponse.body.P_ERR_CODE === 'S') {
          ...
          await Actions.fireDataProviderEvent(context, {
            target: $variables.disciplineADP,
            refresh: null
          });

          console.log("+++++++++++++123: ", JSON.stringify($variables.disciplineADP.data));
          console.log("+++++++++++++1234: ", JSON.stringify(dataResponse.body.OUTPUT));
          $variables.disciplineADP.data = dataResponse.body.OUTPUT || [];

          await Actions.fireNotificationEvent(context, {
            summary: 'Discipline Wise Inspection rows added successfully',
          ...
          await Actions.fireNotificationEvent(context, {
            summary: 'Failed to add Discipline Wise Inspection rows',
            displayMode: 'transient',
          });
        }
      } catch (error) {
        console.error('Error adding Discipline Wise Inspection rows:', error);
        await Actions.fireNotificationEvent(context, {
