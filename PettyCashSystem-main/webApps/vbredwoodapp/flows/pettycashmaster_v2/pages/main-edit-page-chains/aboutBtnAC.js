define([
  ...
  class aboutBtnAC extends ActionChain {
    ...
    async run(context, { event, originalEvent, key, index, current }) {
      ...
      $variables.about.created_date = current.row.created_date;
      $variables.about.last_updated_by = current.row.last_updated_by;
      $variables.about.last_updated_date = current.row.last_updated_date;
      $variables.about.last_updated_login = current.row.last_updated_login;
