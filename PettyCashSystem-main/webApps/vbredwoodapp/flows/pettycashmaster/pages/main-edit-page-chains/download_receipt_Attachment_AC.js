define([
  ...
  class download_receipt_Attachment_AC extends ActionChain {
    ...
    async run(context, { event, originalEvent, key, index, current }) {
      ...
      try {
        ...
        if (key !== null && $variables.payload.claim_header_id != null) {
          ...
          // let temp_key = await $application.functions.encryptJs_Normal($application.constants.secretKey, key);
  ...
  return download_receipt_Attachment_AC;
});
