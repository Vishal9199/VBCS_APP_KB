      ...
      switch (actionId) {
        ...
        case 'withdraw': {
          ...
          if (response.body.count === 1) {
            ...
            // // $flow.variables.updateActionObj.P_TRX_ID = $variables.pNavId;
            // $flow.variables.updateActionObj.P_TRX_ID = response.body.items[0].transaction_id;
            // $flow.variables.updateActionObj.P_ACTION_USER = $application.user.email;
            // $flow.variables.updateActionObj.P_ACTION_USER_IDCS = $application.user.userId;
        ...
        case 'reassign': {
          ...
          if (response.body.count === 1) {
            ...
            // $flow.variables.updateActionObj.P_INSTANCE_NUMBER = response.body.items[0].approval_instance_num;
            // $flow.variables.updateActionObj.P_FROM_PERSON_ID = $application.variables.getEmployeeDetailTypeVar.user_id;
            // $flow.variables.updateActionObj.P_APPR_LEVEL = response.body.items[0].approver_level;
        ...
        case 'about': {
          ...
          $variables.about.created_by = $variables.payload.created_by;
          $variables.about.created_date = $variables.payload.created_date;
          $variables.about.last_updated_by = $variables.payload.last_updated_by;
          $variables.about.last_updated_date = $variables.payload.last_updated_date;
          $variables.about.last_updated_login = $variables.payload.last_updated_login;
          break;
        }
        case 'approvalHistory': {
          ...
          await Actions.openUrl(context, {
            ...
            params: {
              ...
              'lv_title': 'Petty Cash',
              'lv_appr_request_code': 'Petty Cash',
            },
          });
          break;
        }
        case 'attachment': {
          // if ($variables.payload.claim_header_id === 0) {

          //   if ($variables.headerFormValid === 'valid') {
          //     await Actions.callChain(context, {
          //       chain: 'savePettyCashHeaderAC',
          //     });
          // let encryptHdrId = $application.functions.encryptJs($application.constants.secretKey, $variables.payload.claim_header_id);
          // let encryptReqNumber = $application.functions.encryptJs($application.constants.secretKey, $variables.requestDetailVar.request_number);

          //     const toAttachment3 = await Actions.navigateToFlow(context, {
          //       flow: 'attachment',
          //       target: 'parent',
          //       page: 'attachment-start',
          //       params: {
          //         'P_APPLICATION_CODE': $constants.stored_Appl_Code,
          //         'P_SCREEN_NAME': $variables.pageTitle,
          //         'P_STATUS': $variables.requestDetailVar.status_code,
          //         'P_TRANSACTION_ID': encryptHdrId,
          ...
          let temp_hdr_id = await Actions.callChain(context, {
            ...
            params: {
              plainText: $variables.payload.claim_header_id,
            },
          });
          ...
          const toAttachment = await Actions.navigateToFlow(context, {
            ...
            params: {
              ...
              'P_SCREEN_NAME': 'Petty Cash',
              'P_APPLICATION_CODE': $constants.stored_Appl_Code,
              'P_TRANSACTION_NUMBER': encryptReqNumber,
              'P_STATUS': $variables.payload.status_code,
            },
          });
          // }
          break;
