...
mapAllFields(source) {
  return {
    claim_header_id: source.claim_header_id,
    object_version_num: source.object_version_num,
    claim_number: source.claim_number,
    request_date: source.request_date,
    petty_cash_type: source.petty_cash_type,
    petty_cash_name: source.petty_cash_name,
    governorate: source.governorate,
    supplier_id: source.supplier_id,
    supplier_name: source.supplier_name,
    supplier_number: source.supplier_number,
    supplier_site_id: source.supplier_site_id,
    supplier_site_code: source.supplier_site_code,
    status_id: source.status_id,
    status_code: source.status_code,
    status_name: source.status_name,
    open_balance_amt: source.open_balance_amt,
    receipt_amt: source.receipt_amt,
    claim_amt: source.claim_amt,
    staff_iou_amt: source.staff_iou_amt,
    close_balance_amt: source.close_balance_amt,
    cash_in_hand: source.cash_in_hand,
    comments: source.comments,
    saas_transaction_id: source.saas_transaction_id,
    saas_transaction_number: source.saas_transaction_number,
    integration_status_id: source.integration_status_id,
    integration_status_code: source.integration_status_code,
    integration_status_name: source.integration_status_name,
    integration_err_message: source.integration_err_message,
    created_by: source.created_by,
    created_date: source.created_date,
    last_updated_by: source.last_updated_by,
    last_updated_date: source.last_updated_date,
    last_updated_login: source.last_updated_login,
