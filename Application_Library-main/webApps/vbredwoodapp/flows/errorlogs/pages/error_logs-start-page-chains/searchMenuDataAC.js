  ...
  class searchMenuDataAC extends ActionChain {
    ...
    async run(context) {
      ...
      const response = await Actions.callRest(context, {
        endpoint: 'ErrorLog/postStgScheduleSyncErrorLog',
        body: $variables.encryptPayload,
      });

      $variables.errorLogADP.data = response.body.P_OUTPUT;

          $variables.pagingButton.previous = +$variables.searchObj.OFFSET > 0;
