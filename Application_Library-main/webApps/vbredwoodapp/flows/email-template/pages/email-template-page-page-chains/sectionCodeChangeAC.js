define([
  ...
  class sectionCodeChangeAC extends ActionChain {
    ...
    async run(context, { value }) {
      ...
      if (value) {
        ...
        $variables.emailSectionVar.section_code = upperValue;
        ...
        $variables.emailSectionVar.section_title = titleCaseValue;
