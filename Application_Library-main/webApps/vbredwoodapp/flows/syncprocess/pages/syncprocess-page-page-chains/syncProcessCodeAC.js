define([
  ...
  class syncProcessCodeAC extends ActionChain {
    ...
    async run(context, { value }) {
      ...
      // reset messages
      $variables.lookupTypeCodeCustomMsg = [];
      ...
      if (value) {
        ...
        $variables.ScheduleSyncSearchVar.schedule_id = upperValue;
        ...
        if (!validPattern.test(upperValue)) {
          ...
          $variables.ScheduleSyncSearchVar.schedule_name = titleCaseValue;
        }
      }
    }
