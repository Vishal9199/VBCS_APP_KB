define([
  ...
  class lookupTypeCodeAC extends ActionChain {
    ...
    async run(context, { value }) {
      ...
      if (value) {
        ...
        $variables.lookupTypeVar.lookup_type_code = upperValue;
        ...
        if (!validPattern.test(upperValue)) {
          ...
          $variables.lookupTypeVar.lookup_type_name = titleCaseValue;
        }
      }
    }
