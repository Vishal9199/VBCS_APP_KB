define([
  ...
  class searchMenuDataAC extends ActionChain {
    ...
    async run(context) {
      ...
      const encryptJs = await $application.functions.encryptJs($application.constants.secretKey, $variables.userSearch);
      ...
      $variables.userAccessADP.data = response.body.P_OUTPUT;
          $variables.pagingButton.previous = +$variables.userSearch.IN_OFFSET > 0;
